...
public class MainStageController {
    ...
    public void addContentPane(String content) {
        // Creating a label with the content
        Label label = new Label(content);

        // Add the label to the GridPane at the next available location
        mainGrid.add(label, nextCol, nextRow);
